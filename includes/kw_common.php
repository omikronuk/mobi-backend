...
if ( ! function_exists('kw_content_replace')):
 function kw_content_replace($key, $post=array()){
    ...
    $page = new PageService();
		...
		//  DB::getSpecificRecordFields('post_content', 'kw_posts', "slug = '$key'"); 
...
if(!function_exists('arrayToObject')){
 ...
 /**
         * @name generateGui
         * this method can generate a random value to be used to uniquely identify objects in the system
         * @params length of the guid to be generated
         * @access public
         * @return string
         */
    function generateGui($len = 5){
		list($usec, $sec)=explode(' ', microtime());
		$rand=(float)$sec+((float)$usec*100000);
		srand($rand);

		return (string)rand(pow(10, $len-1), pow(10, $len)-1);
    }
